...
[BASE] = LAYOUT_dactyl(  // layer 0 : default
        // left hand
          KC_1,           KC_2,     KC_3,     KC_4,  KC_5,          KC_EQL,
          KC_Q,           KC_W,     KC_E,     KC_R,  KC_T,         KC_TAB,
          KC_A,           KC_S,     KC_D,     KC_F,  KC_G,         CTL_T(KC_ESC),
          KC_Z,           KC_X,     KC_C,     KC_V,  KC_B,         KC_LSFT,
       KC_QUOT,  LALT(KC_LSFT),  KC_LEFT,  KC_RGHT,                KC_TILD,
        ...
        // right hand
                             ...
                             KC_N,   KC_M,  KC_COMM,   KC_DOT,     CTL_T(KC_SLSH),         KC_GRV,
